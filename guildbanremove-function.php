<?php
function guildBanRemove($ban, $discord){
	...
	if ($modlog_channel_id && $guild) {
		...
		if ($modlog_channel != null) {
			...
			//	->setTitle("Commands")																	// Set a title
				...
				->setDescription("$guild_name")																// Set a description (below title, above fields)
				->addFieldValues("Unbanned", "<@$user_id>")																// New line after this
