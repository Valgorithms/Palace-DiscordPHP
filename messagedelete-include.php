...
if ( (($message_content == NULL) || ($message_content == "")) && ($message_embeds == NULL) ) {
	...
	$guild_id = $message->guild_id; echo "guild_id $guild_id" . PHP_EOL;
	$channel_id = $message->channel_id; echo "channel_id $channel_id" . PHP_EOL;
	...
	if ($modlog_channel) $modlog_channel->sendMessage($content);
	return true;
...
}else $author_user = $message->author;
...
if (!$guild) return true; //Probably a DM
