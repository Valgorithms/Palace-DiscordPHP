...
function messageUpdateRaw($channel, $data_array, $discord) {
	...
	$member				= $data_array['member']; //if(isset($GLOBALS['debug_echo']) && $GLOBALS['debug_echo']) echo "member: " . var_dump($member) . PHP_EOL; //username, id, discriminator,avatar
	$id					= $data_array['id']; //if(isset($GLOBALS['debug_echo']) && $GLOBALS['debug_echo']) echo "id: " . var_dump($id) . PHP_EOL; //username, id, discriminator,avatar
	...
	$author				= $data_array['author']; //if(isset($GLOBALS['debug_echo']) && $GLOBALS['debug_echo']) echo "author: " . var_dump($author) . PHP_EOL; //username, id, discriminator,avatar
